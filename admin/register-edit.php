                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select name="role_as" required class="fore-control">
                                            ...
                                            <option value="seller" <?= $user['role_as'] == 'seller' ? 'selected':''; ?> >Seller</option>
                                            <option value="buyer" <?= $user['role_as'] == 'buyer' ? 'selected':''; ?> >Buyer</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <button type="submit" name="update_user" class="btn btn-primary">Upadate User</button>
                                    </div>
                                </div>
                            </form>
